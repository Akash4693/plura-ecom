...
export default function ConfirmationPage() {
  ...
  // Memoize the toast function to prevent infinite loop with explicit type annotation
  const showConfirmationToast = useCallback((id: string) => {
    toast({
  ...
  useEffect(() => {
    ...
    // Use the memoized toast function
    ...
    clearCart, 
    clearCheckout, 
    showConfirmationToast, // Use the memoized function in dependencies
    router
  ])
